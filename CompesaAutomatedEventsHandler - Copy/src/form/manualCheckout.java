 ...
 * @author RavenPC
 */
public class manualCheckout extends javax.swing.JPanel {
...
String fullName, event;
    ...
    public void displayTable() {
      ...
      try {
        ...
        while (rs.next()) {
          ...
          row.add("Check out"); // Use text instead of JButton for initial rendering
        ...
        table.getColumn("Check out").setCellRenderer(new manualCheckout.ButtonRenderer());
        table.getColumn("Check out").setCellEditor(new manualCheckout.ButtonEditor(new JCheckBox()));
    ...
    class ButtonRenderer extends JButton implements TableCellRenderer {
      ...
      public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if (column == 6) {
          setBackground(Color.CYAN); // Set the background color to red for "Delete" button
        } else {
                ...
                System.out.println("Student Info: " + fullName);
                       System.out.println("Complete Scanned Value: " + completeScannedValue);
                              System.out.println("Username: " + username);
                                     System.out.println("yearlvl: " +yr);
                                     System.out.println(event);
                                     
                   int rowsAffected = attendanceDao.newUpdate1(completeScannedValue, username, event,yr);

                if (rowsAffected > 0) {
                  JOptionPane.showMessageDialog(null, fullName + "Check-out Successfully", "Check-out Status", JOptionPane.INFORMATION_MESSAGE);

                } else {
                 JOptionPane.showMessageDialog(null, fullName+" Student already checked-out", "Check-out Status", JOptionPane.WARNING_MESSAGE);

                }

              } else {
       
             JOptionPane.showMessageDialog(null, fullName+" Student is Not Registered", "Check-out Status", JOptionPane.WARNING_MESSAGE);
              }
    ...
    public manualCheckout(String eventName,String user) {
      username = user;
      event=eventName;
