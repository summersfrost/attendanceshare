 ...
 * @author RavenPC
 */
public class manualCheckin extends javax.swing.JPanel {
...
String fullName, event;
    ...
    public void displayTable() {
      ...
      try {
        ...
        while (rs.next()) {
          ...
          row.add("Check in"); // Use text instead of JButton for initial rendering
        ...
        table.getColumn("Check in").setCellRenderer(new manualCheckin.ButtonRenderer());
        table.getColumn("Check in").setCellEditor(new manualCheckin.ButtonEditor(new JCheckBox()));
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            try {
              ...
              if (resultSet.next()) {
                ...
                if (rowsAffected > 0) {
                  JOptionPane.showMessageDialog(null, fullName + "Check-in Successfully", "Check-in Status", JOptionPane.INFORMATION_MESSAGE);

                } else {
                 JOptionPane.showMessageDialog(null, fullName+" Student already checked-in", "Check-in Status", JOptionPane.WARNING_MESSAGE);

                }

              } else {
       
             JOptionPane.showMessageDialog(null, fullName+" Student is Not Registered", "Check-in Status", JOptionPane.WARNING_MESSAGE);
              }
    ...
    public manualCheckin(String eventName,String user) {
      username = user;
      event=eventName;
