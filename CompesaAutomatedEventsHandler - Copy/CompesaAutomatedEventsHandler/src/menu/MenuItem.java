...
public class MenuItem extends javax.swing.JPanel {
    ...
    private Color subMenuColor;
     private Color subMenuFontColor;
    ...
    public void setSubMenuColor(Color colorbg, Color colorfg) {
        this.subMenuColor = colorbg;
        this.subMenuFontColor = colorfg;
        for (MenuItem menuItem : subMenu) {
            menuItem.setBackground(subMenuColor);
             menuItem.lbName.setForeground(subMenuFontColor);
        }
    }
    ...
    private void initComponents() {
        ...
        lbName.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
